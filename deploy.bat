...
set PROJECT_DIR=.
set TOMCAT_DIR=D:\Apache Software Foundation\Tomcat 10.1
...
rd /s /q "%TOMCAT_DIR%\webapps\biblio"
del /s /q "%TOMCAT_DIR%\webapps\biblio.war"

mkdir "%BUILD_DIR%\WEB-INF\classes"

echo Compilation des fichiers Java...
:: Recherche recursive des fichiers Java et compilation
